...
namespace Context.CompanyClasses
{
    public class EditPersonalSettings
    {
        ...
        public IWebElement toJobLevelValue => PropertiesCollection.driver.FindElement(By.XPath("/html/body/div[3]/div/div/div/ul/li[3]"));
        ...
        public IWebElement toJobFunctionValue => PropertiesCollection.driver.FindElement(By.XPath("/html/body/div[3]/div/div/div/ul/li[4]"));
        ...
        public IWebElement toContinentValue => PropertiesCollection.driver.FindElement(By.XPath("/html/body/div[4]/div/div/div/ul/li[3]"));
        ...
        public IWebElement toCountryValue => PropertiesCollection.driver.FindElement(By.XPath("/html/body/div[5]/div/div/div/ul/li[1]"));
